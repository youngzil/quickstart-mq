 ...
 * 版权所有 *
 */
package org.quickstart.mq.kafka.v1.sample2.interceptor.consumer;
 ...
 * @since 1.0
 */
public class TimeStampPrependerInterceptor implements ConsumerInterceptor<String, String> {
    ...
    public ConsumerRecords<String, String> onConsume(ConsumerRecords<String, String> records) {
        ...
        System.out.println("consumer.TimeStampPrependerInterceptor.onConsume");
    ...
    public void onCommit(Map<TopicPartition, OffsetAndMetadata> offsets) {
        System.out.println("consumer.TimeStampPrependerInterceptor.onCommit");
    }
    ...
    @Override
    public void close() {
        System.out.println("consumer.TimeStampPrependerInterceptor.close");
