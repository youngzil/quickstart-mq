 ...
 */
package org.quickstart.mq.kafka.v1.sample3;
...
public class Consumer extends Thread {
    ...
    public void consumerMsg(){
    	try {
    		...
    		while(true){
    			ConsumerRecords<Integer, String> records1 = consumer.poll(1000);
    ...
    public static void main(String[] args) {
        Consumer Consumer1 = new Consumer(Constants.TOPIC);
        Consumer Consumer2 = new Consumer(Constants.TOPIC);
        Consumer1.start();
        Consumer2.start();
