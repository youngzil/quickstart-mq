...
//        props.put(ProducerConfig.PARTITIONER_CLASS_CONFIG, "cn.ljh.kafka.kafka_helloworld.SimplePartitioner2");

//        props.put(ProducerConfig.INTERCEPTOR_CLASSES_CONFIG, "org.quickstart.mq.kafka.v2.sample.ProducerInterceptor2");
            ...
            producer.send(data,
                    new Callback() {
                        public void onCompletion(RecordMetadata metadata, Exception e) {
                            ...
                            if (null != metadata) {
                                System.out.println("The offset of the record we just sent is:partition= "  + metadata.partition() + ", offset="+ metadata.offset());
                            }
                        }
                    });
    ...
    public void consumer() {
        ...
        props.put(ConsumerConfig.INTERCEPTOR_CLASSES_CONFIG, "org.quickstart.mq.kafka.v2.sample.ConsumerInterceptor2");
