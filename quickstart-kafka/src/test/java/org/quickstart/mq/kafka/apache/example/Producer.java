 ...
 */
package org.quickstart.mq.kafka.apache.example;
...
public class Producer extends Thread {
    ...
    public Producer(String topic, Boolean isAsync) {
        ...
        props.put("bootstrap.servers", "idh101:6667");
...
class DemoCallBack implements Callback {
    ...
    /**
     * A callback method the user can implement to provide asynchronous handling of request completion. This method will be called when the record sent to the server has been acknowledged. Exactly one
