 ...
 * 版权所有 *
 */
package org.quickstart.mq.activemq.order;
...
public class ActiveMQProducer {
    ...
    public static void main(String[] args) throws JMSException {
        ...
        for (int i = 0; i < 1; i++) {
            ...
            // 同一个queue中，拥有相同JMSXGroupID的消息将发往同一个消费者，解决顺序问题，不同分组的消息又能被其他消费者并行消费，解决负载均衡的问题，两全其美啦
            txtMessage.setStringProperty("JMSXGroupID", "constact-20100000002");
            txtMessage.setIntProperty("JMSXGroupSeq", -1);
