...
public class ActiveMQConsumer {
    ...
    public static void main(String[] args) throws JMSException {
        ...
        String url2 = "failover:(tcp://10.20.16.210:20002,tcp://10.20.16.209:20002,tcp://10.20.16.211:20002)";

        String url3 = "failover:(tcp://localhost:61616)";

        ConnectionFactory connectionFactory = new ActiveMQConnectionFactory(ActiveMQConnection.DEFAULT_USER, ActiveMQConnection.DEFAULT_PASSWORD, url3);
