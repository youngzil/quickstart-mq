...
/**
 * Fires up a mock broker that specializes in routing data of the 'Glam' variety. This particular broker has a special handler that rejects any and all attempts to interact with country music. In
 * addition, it allows for retrieval of events from the broker and their subsequent interrogation.
 */
